...
export default function Statistics() {
  const refreshData = async () => {
    ...
    const contract = new ethers.Contract(
      "0xe50AAC0A78e2Ab8eB779089350c62538ADF047bD",
      ABI,
      signer,
    ); 
    totalDonation = ethers.utils.formatEther(await contract.contractBalance()) //totalDonationAmt();
    console.log("totalDonation" + totalDonation)  
    donated = ethers.utils.formatEther(await contract.contractBalance())   //releasedAmt()
