import { Card, Typography, Image, Button, Popover, Form, InputNumber, Input, message, Space, Table,  } from "antd";
...
const styles = {
  ...
  const data = [
    ...
    {
      key: '2',
      id: "110931588509641076807561390487023463986873057233737171751566698948967065279967",
      description: "Test2",
    },
  ];
...
export default function Governance() {
  ...
  const findProposals = async () => {
    ...
    for (let i=0; i < results.length; i++){
      proposalId.push(results[0][0].attributes.proposalId)
      description.push(results[0][0].attributes.proposalId)
      console.log("i later" + results[0][i].attributes.proposalId)
    console.log("i later" +results[0][i].attributes.description)
    console.log("i before" +results[i][0].attributes.proposalId)
    console.log("i before" +results[i][0].attributes.description)
    }
